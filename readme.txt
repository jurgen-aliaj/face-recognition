...
The produced graph gets data from a pickle file ('results.p') since running the script for every value of k takes too long.
...
The others_cropped folder should contain 32x32 grayscale images of the other actors which naming conventions as above.
If there is no such folder, the script get_others.py will generate one (requires an empty folder named 'others_cropped' exists before running).
